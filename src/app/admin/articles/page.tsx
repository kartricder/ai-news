          ...
          <div key={article.id} className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                <button onClick={() => updateArticle(article.slug, { status: 'published' })} className="rounded-md bg-emerald-600 px-3 py-2 text-xs font-semibold text-white">
                  Publish
                </button>
                <button onClick={() => updateArticle(article.slug, { status: 'rejected' })} className="rounded-md bg-red-600 px-3 py-2 text-xs font-semibold text-white">
                  Reject
                </button>
